...
departments <- read_excel("company1.xlsx", sheet = "departments")
employees   <- read_excel("company1.xlsx", sheet = "employees")
projects    <- read_excel("company1.xlsx", sheet = "projects")
workson     <- read_excel("company1.xlsx", sheet = "workson")
